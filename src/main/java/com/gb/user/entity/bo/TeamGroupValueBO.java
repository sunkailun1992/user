 ...
 *
 * @author sunx
 * @className TeamGroupValueBO
 * @time 2022-08-31 10:59:01
 */
@Data
@ApiModel(value = "团队组别值传输")
public class TeamGroupValueBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {TeamGroupValueBO.Update.class, TeamGroupValueBO.Remove.class}, message = "id不能为空")
    private String id;
