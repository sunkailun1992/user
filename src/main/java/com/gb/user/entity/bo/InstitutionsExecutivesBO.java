 ...
 *
 * @author sunxin
 * @className InstitutionsExecutivesBO
 * @time 2022-07-04 10:48:36
 */
@Data
@ApiModel(value = "机构高管传输")
public class InstitutionsExecutivesBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {InstitutionsExecutivesBO.Update.class, InstitutionsExecutivesBO.Remove.class}, message = "id不能为空")
    private String id;
