 ...
 *
 * @author sunx
 * @className TeamGroupValueLimitBO
 * @time 2022-08-31 10:59:01
 */
@Data
@ApiModel(value = "团队组别限制传输")
public class TeamGroupValueLimitBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {TeamGroupValueLimitBO.Update.class, TeamGroupValueLimitBO.Remove.class}, message = "id不能为空")
    private String id;
