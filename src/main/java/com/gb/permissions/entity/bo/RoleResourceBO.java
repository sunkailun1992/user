 ...
 * @description:	TODO  角色资源表传输
 * @source:  	    代码生成器
 */
@Data
@ApiModel(value = "角色资源表传输")
public class RoleResourceBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {RoleResourceBO.Update.class,RoleResourceBO.Remove.class},message = "id不能为空")
    private String id;
