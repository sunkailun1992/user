 ...
 * @description:	TODO  角色用户组传输
 * @source:  	    代码生成器
 */
@Data
@ApiModel(value = "角色用户组传输")
public class GroupRoleBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {GroupRoleBO.Update.class,GroupRoleBO.Remove.class},message = "id不能为空")
    private String id;
