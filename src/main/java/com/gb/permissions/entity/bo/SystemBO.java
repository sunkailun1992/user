 ...
 * @description:	TODO  系统表传输
 * @source:  	    代码生成器
 */
@Data
@ApiModel(value = "系统表传输")
public class SystemBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {SystemBO.Update.class,SystemBO.Remove.class},message = "id不能为空")
    private String id;
    ...
    @NotBlank(groups = {SystemBO.Save.class},message = "编码不能为空")
