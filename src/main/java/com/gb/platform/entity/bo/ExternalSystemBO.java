 ...
 *
 * @author sunx
 * @className ExternalSystemBO
 * @time 2022-12-16 03:10:08
 */
@Data
@ApiModel(value = "外部系统传输")
public class ExternalSystemBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {ExternalSystemBO.Update.class, ExternalSystemBO.Remove.class}, message = "id不能为空")
    private String id;
