 ...
 * @description:	TODO  用户类型值表传输
 * @source:  	    代码生成器
 */
@Data
@ApiModel(value = "用户类型值表传输")
public class UserTypeValueBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {UserTypeValueBO.Update.class,UserTypeValueBO.Remove.class},message = "id不能为空")
    private String id;
    ...
    @NotBlank(groups = {UserTypeValueBO.Save.class},message = "编码不能为空")
