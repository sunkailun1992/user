 ...
 *
 * @author lijh
 * @className UserAttachmentBO
 * @time 2022-04-14 10:04:04
 */
@Data
@ApiModel(value = "用户附件传输")
public class UserAttachmentBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {UserAttachmentBO.Update.class, UserAttachmentBO.Remove.class}, message = "id不能为空")
    private String id;
