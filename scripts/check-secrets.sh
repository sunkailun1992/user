#!/usr/bin/env bash
# User service secret warning scan: report suspicious credentials without rewriting files.
# Project owners decide whether a credential should become a placeholder, move to Nacos, or stay in current config.
set -euo pipefail
